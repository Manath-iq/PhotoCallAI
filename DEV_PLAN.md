...
- [x] Оптимизировать отображение блоков еды
  - _Готово, если: убрана лишняя кнопка "Итоги дня", удален заголовок "Приёмы пищи сегодня", увеличена фотография до пропорции 4:3 (горизонтальная ориентация), название продукта отображается под фото, улучшен контраст цветового оформления КБЖУ (цветные плашки с белым текстом) с использованием цветов из диаграмм: калории - зеленый, белки - синий, жиры - оранжевый, углеводы - красный_
