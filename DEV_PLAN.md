...
- [x] Оптимизировать отображение блоков еды
  - _Готово, если: убрана лишняя кнопка "Итоги дня", удален заголовок "Приёмы пищи сегодня", увеличена фотография до пропорции 3:4, название продукта отображается под фото, цветовое оформление КБЖУ соответствует диаграммам_
