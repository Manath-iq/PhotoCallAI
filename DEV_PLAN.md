...
- [x] Оптимизировать отображение блоков еды
  - _Готово, если: убрана лишняя кнопка "Итоги дня", удален заголовок "Приёмы пищи сегодня", увеличена фотография на всю доступную ширину, название продукта отображается под фото, информация о КБЖУ представлена в виде цветных блоков с точными цветами из дизайна диаграмм (без использования переменных темы Telegram)_
