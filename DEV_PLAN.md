...
- [x] Оптимизировать отображение блоков еды
  - _Готово, если: убрана лишняя кнопка "Итоги дня", удален заголовок "Приёмы пищи сегодня", увеличена фотография на всю доступную ширину с фиксированной высотой, улучшены скругления углов, оптимизированы отступы, название продукта отображается под фото, кнопка "Удалить" выделена красным цветом с белым текстом, информация о КБЖУ представлена в виде цветных блоков_
